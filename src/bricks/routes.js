...
import { Login, Register, Home, MobileMenu, FourOFour, Story, Dashboard } from 'views';
...
export const AppRoutes = (props) => {
  ...
  return (
    <Switch>
      ...
      <Route exact path='/home/:id' render={() => ((loginStatus === false ? <Redirect to={{ pathname: '/login' }}  {...props} /> : <Layout> <Story  {...props} /></Layout>))} />
